...
const menuItems = [
  { href: "/lp-x7k9m2-internal/manager", icon: LayoutDashboard, label: "Dashboard" },
  { href: "/lp-x7k9m2-internal/manager/users", icon: Users, label: "Usuários" },
  { href: "/lp-x7k9m2-internal/manager/kyc", icon: FileCheck, label: "Aprovar KYC" },
  { href: "/lp-x7k9m2-internal/manager/withdrawals", icon: Banknote, label: "Saques" },
  { href: "/lp-x7k9m2-internal/manager/transactions", icon: ArrowUpDown, label: "Transações" },
];
...
export default function ManagerLayout({
  ...
  const checkAuth = async () => {
    try {
      ...
      if (!roleData.role || !["manager", "ceo"].includes(roleData.role)) {
        router.push("/lp-x7k9m2-internal");
        return;
      }
