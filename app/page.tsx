        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-6 md:pt-8 border-t border-white/5">
            ...
            <div className="flex items-center gap-3 md:gap-4">
              ...
              {/* Discord */}
              <Link href="https://discord.gg/hyperionpay" target="_blank" rel="noopener noreferrer" className="w-8 h-8 md:w-10 md:h-10 bg-[#0a0d1a] border border-white/5 rounded-full flex items-center justify-center hover:border-indigo-500/30 transition-colors">
              ...
              {/* Email */}
              <Link href="mailto:contato@hyperionpay.com" className="w-8 h-8 md:w-10 md:h-10 bg-[#0a0d1a] border border-white/5 rounded-full flex items-center justify-center hover:border-indigo-500/30 transition-colors">
