        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-white/5">
            ...
            <div className="flex items-center gap-4">
              {/* Instagram */}
              <Link href="https://www.instagram.com/legacy_pay/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#111111] border border-white/5 rounded-full flex items-center justify-center hover:border-orange-500/30 transition-colors">
              ...
              {/* Discord */}
              <Link href="https://discord.gg/legacypay" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#111111] border border-white/5 rounded-full flex items-center justify-center hover:border-orange-500/30 transition-colors">
              ...
              {/* WhatsApp */}
              <Link href="https://wa.me/5534999353187" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#111111] border border-white/5 rounded-full flex items-center justify-center hover:border-orange-500/30 transition-colors">
              ...
              {/* Email */}
              <Link href="mailto:contato@legacypay.shop" className="w-10 h-10 bg-[#111111] border border-white/5 rounded-full flex items-center justify-center hover:border-orange-500/30 transition-colors">
